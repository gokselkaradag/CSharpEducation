...
namespace _02_Variables
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("-----------------------------");
            //Console.WriteLine("Yolcu: " + passengerName + " " + passengerSurname + " " + passengerAge + " " + passengerDistrict + " / " + passengerCity + " " + passengerIdentityNumber);

            //Console.ReadLine();
            #endregion Klavyeden String Veri Girişi
